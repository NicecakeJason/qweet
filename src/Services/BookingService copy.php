...
class BookingService extends AbstractService {
    ...
    /**
 * Получает информацию о бронировании по ID (отладочная версия)
 * 
 * @param string|int $booking_id ID бронирования
 * @return array Данные бронирования (тестовые данные)
 */
public function get_booking_by_id($booking_id) {
    // Логируем процесс
    error_log('[Sun Apartament] Запрос бронирования с ID: ' . $booking_id);
    
    // ТОЛЬКО ДЛЯ ОТЛАДКИ! Всегда возвращаем тестовые данные
    // После отладки заменить на полноценную реализацию!
    return [
        'booking_id' => $booking_id,
        'apartament_id' => 1,
